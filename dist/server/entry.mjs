...
import { manifest } from './manifest_B2ioNT_n.mjs';
...
const _page3 = () => import('./pages/credentials.astro.mjs');
const _page4 = () => import('./pages/departments.astro.mjs');
const _page5 = () => import('./pages/news.astro.mjs');
const _page6 = () => import('./pages/partners.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/credentials.astro", _page3],
    ["src/pages/departments/index.astro", _page4],
    ["src/pages/news.astro", _page5],
    ["src/pages/partners.astro", _page6],
