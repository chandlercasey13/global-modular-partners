...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Services", "description": "Multipurpose modular construction services: consulting, design-build, procurement, installation, support, and emergency deployment.", "data-astro-cid-ucd2ps2b": true }, { "default": ($$result2) => renderTemplate`   ${maybeRenderHead()}<section class="sv-hero" data-astro-cid-ucd2ps2b> <div class="sv-hero__panel" data-astro-cid-ucd2ps2b> <div class="mnc-container sv-hero__inner" data-astro-cid-ucd2ps2b> <div class="sv-hero__content" data-astro-cid-ucd2ps2b> <h1 class="sv-hero__h1" data-astro-cid-ucd2ps2b>Engineering the<br data-astro-cid-ucd2ps2b>Future of Construction.</h1> <p class="sv-hero__sub" data-astro-cid-ucd2ps2b>Multipurpose modular construction services — from consulting and design-build to procurement, installation, and emergency deployment.</p> </div> </div> </div> </section>  <section class="sv-advantage" id="our-process" data-astro-cid-ucd2ps2b> <div class="mnc-container" data-astro-cid-ucd2ps2b> <div class="sv-sec-head fade-up" data-astro-cid-ucd2ps2b> <span class="section-tag" data-astro-cid-ucd2ps2b>Our Process</span> </div> <div class="sv-advantage__top fade-up" data-astro-cid-ucd2ps2b> <h2 class="sv-advantage__title" data-astro-cid-ucd2ps2b>
...
Every build is held to a 3-phase pre-fabrication audit and strict final QA process.
  ...
  ], "data-astro-cid-ucd2ps2b": true })}  `, "footer": ($$result2) => renderTemplate`${renderComponent($$result2, "Footer", $$Footer, { "slot": "footer", "data-astro-cid-ucd2ps2b": true })}`, "header": ($$result2) => renderTemplate`${renderComponent($$result2, "Header", $$Header, { "slot": "header", "data-astro-cid-ucd2ps2b": true })}` })} `;
